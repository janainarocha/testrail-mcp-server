...
export class TestRailPlansAPI extends TestRailBase {
	...
	async getPlans(
		...
		if (options.is_completed !== undefined) params.push(`is_completed=${options.is_completed ? 1 : 0}`);
	 ...
	 */
	async addPlan(projectId: number, data: any): Promise<any> {
	 ...
	 */
	async addPlanEntry(planId: number, data: any): Promise<any> {
	 ...
	 */
	async addRunToPlanEntry(planId: number, entryId: string, data: any): Promise<any> {
	 ...
	 */
	async updatePlan(planId: number, data: any): Promise<any> {
	 ...
	 */
	async updatePlanEntry(planId: number, entryId: string, data: any): Promise<any> {
	 ...
	 */
	async updateRunInPlanEntry(runId: number, data: any): Promise<any> {
