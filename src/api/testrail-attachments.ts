...
export class TestRailAttachments extends TestRailBase {
	 ...
	 */
	async addAttachmentToCase(caseId: number, filePath: string, filename?: string): Promise<AttachmentUploadResponse> {
	 ...
	 * Maximum upload size: 256MB
	 */
	async addAttachmentToPlan(planId: number, filePath: string, filename?: string): Promise<AttachmentUploadResponse> {
	 ...
	 * Maximum upload size: 256MB
	 */
	async addAttachmentToPlanEntry(planId: number, entryId: number, filePath: string, filename?: string): Promise<AttachmentUploadResponse> {
	 ...
	 */
	async addAttachmentToResult(resultId: number, filePath: string, filename?: string): Promise<AttachmentUploadResponse> {
	 ...
	 * Maximum upload size: 256MB
	 */
	async addAttachmentToRun(runId: number, filePath: string, filename?: string): Promise<AttachmentUploadResponse> {
	 ...
	 * Requires TestRail 5.7 or later
	 */
	async getAttachmentsForCase(caseId: number, options?: {
		limit?: number;
		offset?: number;
		...
		return this.makeRequest<AttachmentsResponse>(endpoint);
	}
	 ...
	 * Requires TestRail 6.3 or later
	 */
	async getAttachmentsForPlan(planId: number, options?: {
		limit?: number;
		offset?: number;
	}): Promise<AttachmentsResponse> {
	 ...
	 * Requires TestRail 6.3 or later
	 */
	async getAttachmentsForPlanEntry(planId: number, entryId: number, options?: {
		limit?: number;
		offset?: number;
	}): Promise<AttachmentsResponse> {
	 ...
	 * Requires TestRail 6.3 or later
	 */
	async getAttachmentsForRun(runId: number, options?: {
		limit?: number;
		offset?: number;
	}): Promise<AttachmentsResponse> {
	 ...
	 * Requires TestRail 5.7 or later
	 */
	async getAttachmentsForResult(resultId: number, options?: {
		limit?: number;
		offset?: number;
	}): Promise<AttachmentsResponse> {
	 ...
	 * Requires TestRail 5.7 or later
	 */
	async getAttachmentsForTest(testId: number, options?: {
		limit?: number;
		offset?: number;
	}): Promise<AttachmentsResponse> {
	 ...
	 */
	async getAttachment(attachmentId: string | number): Promise<ArrayBuffer> {
	 ...
	 */
	private async uploadAttachment(endpoint: string, filePath: string, filename?: string): Promise<AttachmentUploadResponse> {
