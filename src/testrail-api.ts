...
export class TestRailAPI {
  ...
  async getProjects(): Promise<Project[]> {
    return this.makeRequest<Project[]>('get_projects');
  }
  ...
  async getSuites(projectId: number): Promise<Suite[]> {
    return this.makeRequest<Suite[]>(`get_suites/${projectId}`);
  }
   ...
   */
  async getCases(projectId: number, suiteId?: number, sectionId?: number): Promise<{ cases: TestCase[] }> {
    ...
    return this.makeRequest<{ cases: TestCase[] }>(endpoint);
  }
   ...
   */
  async getCasesAdvanced(projectId: number, options: {
    suiteId?: number;
    sectionId?: number;
    filter?: string;
    priorityIds?: number[];
   ...
   */
  async getMilestones(projectId: number, options: {
    isCompleted?: boolean;
    isStarted?: boolean;
    limit?: number;
    offset?: number;
   ...
   * Add new milestone
   */
  async addMilestone(projectId: number, milestone: {
    name: string;
    description?: string;
    dueOn?: Date;
    startOn?: Date;
   ...
   * Update milestone
   */
  async updateMilestone(milestoneId: number, updates: {
    name?: string;
    description?: string;
    isCompleted?: boolean;
    isStarted?: boolean;
   ...
   */
  async addRun(projectId: number, runData: {
    suiteId?: number;
    name: string;
    description?: string;
    milestoneId?: number;
   ...
   */
  async updateRun(runId: number, updates: {
    name?: string;
    description?: string;
    milestoneId?: number;
    includeAll?: boolean;
   ...
   */
  async getSharedSteps(projectId: number, filters?: {
    createdAfter?: Date;
    createdBefore?: Date;
    createdBy?: number[];
    updatedAfter?: Date;
   ...
   */
  async addSharedStep(projectId: number, sharedStepData: {
    title: string;
    steps: Array<{
      content?: string;
      expected?: string;
   ...
   * @param updates - Fields to update
   */
  async updateSharedStep(sharedStepId: number, updates: {
    title?: string;
    steps?: Array<{
      content?: string;
      expected?: string;
   ...
   */
  async addSuite(projectId: number, suiteData: {
    name: string;
    description?: string;
  }): Promise<any> {
   ...
   * @param updates - Fields to update
   */
  async updateSuite(suiteId: number, updates: {
    name?: string;
    description?: string;
  }): Promise<any> {
   ...
   */
  async moveSection(sectionId: number, moveData: {
    parentId?: number;
    afterId?: number;
  }): Promise<any> {
   ...
   * @param filters - Optional filters
   */
  async getTests(runId: number, filters?: {
    statusId?: number[];
    labelId?: number[];
    limit?: number;
    offset?: number;
   ...
   */
  async addVariable(projectId: number, variableData: {
    name: string;
  }): Promise<any> {
   ...
   * @param updates - Fields to update
   */
  async updateVariable(variableId: number, updates: {
    name: string;
  }): Promise<any> {
