 ...
 */
export function registerRunTools(server, clients) {
    /**
     ...
     */
    server.registerTool("testrail_get_runs", {
     ...
     */
    server.registerTool("testrail_add_run", {
     ...
     */
    server.registerTool("testrail_update_run", {
     ...
     */
    server.registerTool("testrail_close_run", {
...
//# sourceMappingURL=runs-tools.js.map