 ...
 */
export function registerResultTools(server, clients) {
    /**
     * Get test results for a specific test
     */
    server.registerTool("testrail_get_results", {
     ...
     */
    server.registerTool("testrail_get_results_for_case", {
     ...
     */
    server.registerTool("testrail_get_results_for_run", {
     ...
     */
    server.registerTool("testrail_add_result", {
     ...
     */
    server.registerTool("testrail_add_result_for_case", {
     ...
     */
    server.registerTool("testrail_add_results", {
     ...
     */
    server.registerTool("testrail_add_results_for_cases", {
     ...
     */
    server.registerTool("testrail_get_result_fields", {
...
//# sourceMappingURL=results-tools.js.map