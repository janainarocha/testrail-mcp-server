 ...
 */
export function registerStatusTools(server, clients) {
    /**
     * Get all test statuses (system and custom)
     */
    server.registerTool("testrail_get_statuses", {
     ...
     */
    server.registerTool("testrail_get_case_statuses", {
...
//# sourceMappingURL=statuses-tools.js.map