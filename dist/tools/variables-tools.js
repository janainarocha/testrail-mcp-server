 ...
 */
export function registerVariableTools(server, clients) {
    /**
     * Get all variables for a project
     */
    server.registerTool("testrail_get_variables", {
     ...
     */
    server.registerTool("testrail_add_variable", {
     ...
     */
    server.registerTool("testrail_update_variable", {
     ...
     * Delete a variable
     */
    server.registerTool("testrail_delete_variable", {
...
//# sourceMappingURL=variables-tools.js.map