 ...
 */
export function registerPlanTools(server, clients) {
    /**
     * Add a new test plan entry (add a new test run/suite to a plan)
     */
    server.registerTool("testrail_add_plan_entry", {
     ...
     */
    server.registerTool("testrail_get_plan", {
     ...
     */
    server.registerTool("testrail_get_plans", {
     ...
     */
    server.registerTool("testrail_add_run_to_plan_entry", {
     ...
     */
    server.registerTool("testrail_update_plan", {
     ...
     */
    server.registerTool("testrail_update_plan_entry", {
     ...
     */
    server.registerTool("testrail_update_run_in_plan_entry", {
     ...
     */
    server.registerTool("testrail_close_plan", {
